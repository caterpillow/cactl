...
\section{Bigger types}
	\begin{itemize}[noitemsep]
		...
		\item \texttt{\_\_float128}: 113-bit mantissa (\tilde{}34 digits), software emulated (\tilde{}100$\times$ slower). Arithmetic and casts just work; \texttt{sqrtq}, \texttt{expq} and printing need \texttt{<quadmath.h>} + \texttt{-lquadmath}, so print via \texttt{(long double)} or peel digits manually.
	\end{itemize}
