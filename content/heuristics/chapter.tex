...
\section{Tips}
	...
	Default temperature schedule for SA: $t = t_0 \cdot (\frac{t_n}{t_0})^{\text{time\_passed}}, \text{time\_passed} \in [0, 1]$
	Acceptance function: $RNG() < \operatorname{exp}((\text{cur} - \text{new}) / t)$
	...
	\begin{itemize}
		...
		\item Scale transitions with temperature (maybe?)
		\item (rarely) kicks
